...
export const cyberStories: CyberStory[] = [
  ...
  story: [
    "ଭୁବନେଶ୍ୱରର ଆଇଟି ହବ୍ (Infocity) ରେ ଥିବା ଏକ ପ୍ରତିଷ୍ଠିତ ସରକାରୀ ଶିକ୍ଷା ଓ ଦକ୍ଷତା ବିକାଶ ପ୍ରତିଷ୍ଠାନର ସାଇବର ସୁରକ୍ଷା ବିଭାଗ। ମେ ମାସର ଗୋଟେ ଗରମ ଅପରାହ୍ନ। ଏୟାର କଣ୍ଡିସନରର ସଁ ସଁ ଶବ୍ଦ ଭିତରେ କମ୍ପ୍ୟୁଟର ସ୍କ୍ରିନକୁ ଚାହିଁ ବସିଥିଲା ମାନସ। ମାନସ ଜଣେ ଉତ୍ସାହୀ ସାଇବର ସିକ୍ୟୁରିଟି ଆନାଲିଷ୍ଟ (Cybersecurity Analyst)। ନୂଆ ନୂଆ ଟେକ୍ନୋଲୋଜି ବିଷୟରେ ଜାଣିବା ଏବଂ କମ୍ପ୍ଲେକ୍ସ ମାଲୱେୟାର୍ (Malware) ର କୋଡ୍ ସବୁକୁ ନିଜ ଲ୍ୟାବରେ ପରୀକ୍ଷା କରିବା ତାର ପସନ୍ଦ। ସେ ସବୁବେଳେ କହେ, 'ସାଇବର ସୁରକ୍ଷା ହେଉଛି ଆଧୁନିକ ଯୁଗର ମହାଭାରତ, ଯେଉଁଠି ହ୍ୟାକରମାନେ ପ୍ରତିଦିନ ନୂଆ ନୂଆ ଚକ୍ରବ୍ୟୂହ ରଚନା କରନ୍ତି।'",
    "ହଠାତ୍, ତାର ବରିଷ୍ଠ ମ୍ୟାନେଜର ସମୀର ବାବୁ ଏବଂ ଅଫିସର ଆସିଷ୍ଟାଣ୍ଟ ସୁଧାଂଶୁ ଦୌଡ଼ି ଦୌଡ଼ି ମାନସ ପାଖକୁ ଆସିଲେ। ସୁଧାଂଶୁର ମୁହଁ ଡରରେ ଶେତା ପଡ଼ିଯାଇଥିଲା। 'ମାନସ! ସର୍ବନାଶ ହୋଇଗଲା, ମୋ କମ୍ପ୍ୟୁଟରର ସବୁ ଫାଇଲ୍ ଆପେ ଆପେ ବନ୍ଦ ହୋଇଯାଉଛି ଏବଂ ସ୍କ୍ରିନରେ କିଛି ଅଜବ ଲେଖା ଆସୁଛି!' ସୁଧାଂଶୁ କହିଲା।",
    "ମାନସ କାଳବିଲମ୍ବ ନକରି ସୁଧାଂଶୁର ଡେସ୍କ ପାଖକୁ ଗଲା। ସେ ଦେଖିଲା ଯେ କମ୍ପ୍ୟୁଟରର ସମସ୍ତ ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ଡକ୍ୟୁମେଣ୍ଟଗୁଡିକର ଏକ୍ସଟେନସନ୍ ବଦଳି .xelera ହୋଇଯାଇଛି ଏବଂ ସ୍କ୍ରିନରେ ଏକ ଲେଖା ଆସିଛି—'Your files are encrypted. Pay Bitcoin to decrypt.' ଏହା ଏକ ଭୟଙ୍କର ରାନସମୱେୟାର୍ (Ransomware) ଆକ୍ରମଣ ଥିଲା!",
    "ମାନସ ପଚାରିଲା, 'ଆଚ୍ଛା ସୁଧାଂଶୁ ଭାଇ, ତୁମେ ଶେଷ ଥର କଣ କ୍ଲିକ୍ କରିଥିଲ, ତୁମର ମାନେପଡୁଛି ?' ସୁଧାଂଶୁ ଥରୁଥରୁ କହିଲା, 'ମୋ ସାନଭାଇ ପାଇଁ ଏକ ସରକାରୀ ଚାକିରିର ନୋଟିଫିକେସନ୍ ଆସିଥିଲା—Odisha_Govt_Job_2026_Notice.pdf। ମୁଁ ସେଇଟାକୁ ଡାଉନଲୋଡ୍ କରି ଓପନ୍ କଲି, ବ୍ୟସ୍ତତାରେ ଦେଖିଲିନି ଯେ ତାର ଏକ୍ସଟେନସନ୍ ପ୍ରକୃତରେ .pdf.exe ଥିଲା।'",
    "ମାନସ ତୁରନ୍ତ ବୁଝିଗଲା ଯେ ଏହା ଏକ 'ଫେକ୍ ଗଭର୍ଣ୍ଣମେଣ୍ଟ ଜବ୍ ନୋଟିଫିକେସନ୍' (Fake Government Job Notification)। ସେ ପ୍ରଥମେ ନିଜର ଉପସ୍ଥିତ ବୁଦ୍ଧି ଖଟାଇ ସୁଧାଂଶୁର କମ୍ପ୍ୟୁଟରରୁ ଲ୍ୟାନ୍ (LAN) କେବୁଲ୍ ବାହାର କରିଦେଲା, ଯଦ୍ୱାରା ଏହି ସଂକ୍ରମଣ ଅନ୍ୟ କମ୍ପ୍ୟୁଟର ବା ମେନ୍ ସର୍ଭରକୁ ବ୍ୟାପିବ ନାହିଁ।",
    "କିନ୍ତୁ ସମସ୍ୟା ଏତିକିରେ ସରିନଥିଲା। ମାନସ ନିଜର ରିସର୍ଚ୍ଚ ଆରମ୍ଭ କଲା। ସେ ନେଟୱର୍କ ଟ୍ରାଫିକ୍ ଲଗ୍ସ (Network Traffic Logs) ଯାଞ୍ଚ କରିବା ସମୟରେ ଏକ ଅଜବ ଜิନିଷ ଲକ୍ଷ୍ୟ କଲା। ଏହି ମାଲୱେୟାର୍ କେବଳ ଫାଇଲ୍ ଲକ୍ କରୁନଥିଲା, ବରଂ ପ୍ରତିଷ୍ଠାନ୍‌ର ବହୁ ଗୁପ୍ତ ତଥା ଗୁରୁତ୍ବପୁର୍ଣ ତଥ୍ୟ ଚୋରି କରି ବାହାରକୁ ପଠାଉଥିଲା। ସେ ଦେଖିଲା ଯେ ଆଉଟ୍‌ବାଉଣ୍ଡ ଟ୍ରାଫିକ୍ ଏକ 'ଡିସକର୍ଡ ୱେବହୁକ୍' (Discord Webhook) ମାଧ୍ୟମରେ ହ୍ୟାକରର ସର୍ଭରକୁ ଯାଉଛି।",
    "ଏହି ନୂଆ ଧರଣର ଆକ୍ରମଣ ବିଷୟରେ ସୂଚନା ପାଇବା ପାଇଁ ସେ ତୁରନ୍ତ ହାଇଦ୍ରାବାଦରେ ଥିବା ତାର ସାଇବର ସିକ୍ୟୁରିଟି ସାଙ୍ଗ ଅମିତ୍ ସହିତ ଫୋନେରେ ଯୋଗାଯୋଗ କଲା। ଅମିତ୍ ତାର ଥ୍ରେଟ୍ ଇଣ୍ଟେଲିଜେନ୍ସ ଡାଟାବେସ୍ ଚେକ୍ କରି କହିଲା: 'ମାନସ, ଏହା ସାଧାରଣ ଆକ୍ରମଣ ନୁହେଁ। ଏହା ହେଉଛି ଭାରତରେ ନିକଟରେ ଦେଖାଦେଇଥିବା 'XELERA' କ୍ୟାମ୍ପେନ୍, ଯାହା ଶିକ୍ଷା ଓ ସରକାରୀ ପ୍ରତିଷ୍ଠାନ ଗୁଡିକୁ ଟାର୍ଗେଟ୍ କରୁଛି। ଏହା ଏକ ପାଇଥନ୍-ଭିତ୍ତିକ (Python-based) ପେଲୋଡ୍।'",
    ...
    "ସମୀର ବାବୁ ମାନସ ପାଖକୁ ଆସିଲେ ଓ ମାନସର ପିଠି ଥାପୁଡ଼େଇ କହିଲେ, 'ମାନସ, ଆଜି ତୁମର ରିସର୍ଚ୍ଚ ଏବଂ ସଠିକ ସମୟ ନିଷ୍ପତ୍ତି ଆମ ସଂସ୍ଥାକୁ ଏକ ବଡ଼ ସାଇବର ବିପଦରୁ ବଞ୍ଚାଇ ଦେଲା।'",
    "ମାନସ ହସିଲା ଏବଂ ଅଫିସର ସମସ୍ତଙ୍କକୁ ସତର୍କ କରାଇ କହିଲା, 'ସାର୍, ଆଜି ଭାଗ୍ୟ ଭଲ ଥିଲା। କିନ୍ତୁ ସର୍ବଦା ମନେରଖନ୍ତୁ—ଯେକୌଣସି ଅଜଣା ଲିଙ୍କ୍ ବା ଚାକିରି ବିଜ୍ଞାପନ ଉପରେ କ୍ଲିକ୍ କରିବା ପୂର୍ବରୁ ୧0 ଥର ଭାବନ୍ତୁ। ସାଇବର ସୁରକ୍ଷା କେବଳ ଆଣ୍ଟିଭାଇରସ୍ ସଫ୍ଟୱେୟାର୍ ନୁହେଁ, ବରଂ ଆମର ସଚେତନତା (Cyber Hygiene) ଉପରେ ଅଧିକ ନିର୍ଭର କରେ।'",
    "ଭୁବନେଶ୍ୱରର ସେହି ଛୋଟ ସାଇବର ସେଲ୍ କ୍ୟାବିନରୁ ବାହାରି ମାନସ ଆକାଶକୁ ଚାହିଁଲା। ସେ ଜାଣିଥିଲା ଯେ ଏହି ଡିଜିଟାଲ୍ ଚକ୍ରବ୍ୟୂହରେ ଆଗକୁ ଆହୁରି ଅନେକ ଯୁଦ୍ଧ ବାକି ଅଛି!"
  ],
  lessons: [
